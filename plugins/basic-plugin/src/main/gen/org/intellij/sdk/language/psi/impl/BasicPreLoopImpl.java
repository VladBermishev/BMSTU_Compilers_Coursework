...
public class BasicPreLoopImpl extends ASTWrapperPsiElement implements BasicPreLoop {

  public BasicPreLoopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BasicVisitor visitor) {
    visitor.visitPreLoop(this);
  }
