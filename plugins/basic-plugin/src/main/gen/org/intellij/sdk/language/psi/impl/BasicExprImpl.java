...
public class BasicExprImpl extends ASTWrapperPsiElement implements BasicExpr {
  ...
  @Override
  @NotNull
  public List<BasicArithmExpr> getArithmExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BasicArithmExpr.class);
  }

  @Override
  @Nullable
  public BasicCmpOp getCmpOp() {
    return findChildByClass(BasicCmpOp.class);
  }
