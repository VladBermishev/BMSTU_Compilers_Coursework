...
public class BasicVarnameOrArrayParamImpl extends ASTWrapperPsiElement implements BasicVarnameOrArrayParam {

  public BasicVarnameOrArrayParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BasicVisitor visitor) {
    visitor.visitVarnameOrArrayParam(this);
  }
