...
public class BasicInitializerListValueImpl extends ASTWrapperPsiElement implements BasicInitializerListValue {

  public BasicInitializerListValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BasicVisitor visitor) {
    visitor.visitInitializerListValue(this);
  }
