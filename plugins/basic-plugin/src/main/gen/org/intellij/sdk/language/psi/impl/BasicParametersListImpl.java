...
public class BasicParametersListImpl extends ASTWrapperPsiElement implements BasicParametersList {

  public BasicParametersListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public BasicVarnameOrArrayParam getVarnameOrArrayParam() {
    return findChildByClass(BasicVarnameOrArrayParam.class);
  }
