...
public class BasicNonEmptyArgumentsListImpl extends ASTWrapperPsiElement implements BasicNonEmptyArgumentsList {

  public BasicNonEmptyArgumentsListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BasicVisitor visitor) {
    visitor.visitNonEmptyArgumentsList(this);
  }
