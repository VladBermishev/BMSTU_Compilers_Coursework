...
public class BasicPostLoopImpl extends ASTWrapperPsiElement implements BasicPostLoop {

  public BasicPostLoopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BasicVisitor visitor) {
    visitor.visitPostLoop(this);
  }
  ...
  @Override
  @NotNull
  public BasicPostLoopExpr getPostLoopExpr() {
    return findNotNullChildByClass(BasicPostLoopExpr.class);
  }
