...
public class BasicFuncCallImpl extends ASTWrapperPsiElement implements BasicFuncCall {

  public BasicFuncCallImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public BasicNonEmptyArgumentsList getNonEmptyArgumentsList() {
    return findNotNullChildByClass(BasicNonEmptyArgumentsList.class);
  }
