...
public class BasicElseStatementImpl extends ASTWrapperPsiElement implements BasicElseStatement {

  public BasicElseStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public BasicStatements getStatements() {
    return findChildByClass(BasicStatements.class);
  }
