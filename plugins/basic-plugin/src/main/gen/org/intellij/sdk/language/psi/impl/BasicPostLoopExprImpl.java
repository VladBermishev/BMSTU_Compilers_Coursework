...
public class BasicPostLoopExprImpl extends ASTWrapperPsiElement implements BasicPostLoopExpr {

  public BasicPostLoopExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BasicVisitor visitor) {
    visitor.visitPostLoopExpr(this);
  }
