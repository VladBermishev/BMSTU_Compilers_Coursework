...
public class BasicIfStatementImpl extends ASTWrapperPsiElement implements BasicIfStatement {

  public BasicIfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public BasicElseStatement getElseStatement() {
    return findNotNullChildByClass(BasicElseStatement.class);
  }
